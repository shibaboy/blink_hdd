...
def disk_on(enclosure, bay):
	...
	if bay == "1":
		...
		temp = temp[:172] + '81 00 02 20' + temp[183:]
        elif bay == "14":
		temp = temp[:184] + '81 00 02 20' + temp[195:]
        elif bay == "15":
		temp = temp[:196] + '81 00 02 20' + temp[207:]
        elif bay == "16":
		temp = temp[:208] + '81 00 02 20' + temp[219:]
        elif bay == "17":
		temp = temp[:221] + '81 00 02 20' + temp[232:]
        elif bay == "18":
		temp = temp[:233] + '81 00 02 20' + temp[244:]
        elif bay == "19":
		temp = temp[:245] + '81 00 02 20' + temp[256:]
        elif bay == "20":
		temp = temp[:257] + '81 00 02 20' + temp[268:]
        elif bay == "21":
		temp = temp[:270] + '81 00 02 20' + temp[281:]
        elif bay == "22":
		temp = temp[:282] + '81 00 02 20' + temp[293:]
        elif bay == "23":
		temp = temp[:294] + '81 00 02 20' + temp[305:]
        elif bay == "24":
		temp = temp[:306] + '81 00 02 20' + temp[317:]
	else:
                print "not here.\n"
	f.close()
        print temp
...
def disk_off(enclosure, bay):
	...
	print temp
		...
		temp = temp[:172] + '80 00 00 00' + temp[183:]
	elif bay == "14":
		temp = temp[:184] + '80 00 00 00' + temp[195:]
	elif bay == "15":
		temp = temp[:196] + '80 00 00 00' + temp[207:]
	elif bay == "16":
		temp = temp[:208] + '80 00 00 00' + temp[219:]
	elif bay == "17":
		temp = temp[:221] + '80 00 00 00' + temp[232:]
	elif bay == "18":
		temp = temp[:233] + '80 00 00 00' + temp[244:]
	elif bay == "19":
		temp = temp[:245] + '80 00 00 00' + temp[256:]
	elif bay == "20":
		temp = temp[:257] + '80 00 00 00' + temp[268:]
	elif bay == "21":
		temp = temp[:270] + '80 00 00 00' + temp[281:]
	elif bay == "22":
		temp = temp[:282] + '80 00 00 00' + temp[293:]
	elif bay == "23":
		temp = temp[:294] + '80 00 00 00' + temp[305:]
	elif bay == "24":
		temp = temp[:306] + '80 00 00 00' + temp[317:]
	f.close()
        print temp
